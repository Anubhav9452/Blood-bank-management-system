                 ...
                 $name=$_POST['name'];
                  ...
                  else
                  {
                    $nameerror ='<div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <strong>only lower , upper and space characters are allowed</strong>
...
else
{
  ...
  <strong>only plzz select respective gender</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
   </div>'; 
  ...
  else
{
  ...
  <strong>plzz select correct date</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>'; 
...
else
{
  $montherror ='<div class="alert alert-danger alert-dismissible fade show" role="alert">
    <strong>plzz select correct month</strong>
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
    </button>
     </div>'; 
...
else
{
  ...
  <strong>plzz select correct year</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>'; 
...
else
{
  ...
  <strong>plzz select correct blood group</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>'; 
...
if(isset($_POST['city']) && !empty($_POST['city']) )
   ...
   if(preg_match('/^[A-Za-z\s]+$/', $_POST['city']))
 {
  ...
  <strong>select your city name correctly</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
  </div>';
...
if(isset($_POST['contact_no']) && !empty($_POST['contact_no']) )
   ...
   if(preg_match('/\d{10}/', $_POST['contact_no']))
 {
  ...
  <strong>contact format does not match</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
  </div>';
  ...
  {
    $contacterror ='<div class="alert alert-danger alert-dismissible fade show" role="alert">
  <strong>fill ur contact_no</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
  </div>';
...
$passworderror ='<div class="alert alert-danger alert-dismissible fade show" role="alert">
  ...
  {
    $passworderror ='<div class="alert alert-danger alert-dismissible fade show" role="alert">
  <strong>plz fill password field</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
  </div>';
...
if(isset($_POST['email']) && !empty($_POST['email']) )
...

 {
  ...
  {
  $emailerror ='<div class="alert alert-danger alert-dismissible fade show" role="alert">
  <strong>email format does not match</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
  </div>';
  ...
  {
    $emailerror ='<div class="alert alert-danger alert-dismissible fade show" role="alert">
  <strong>fill ur email-id</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
  </div>';
...
$submitsuccess ='<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>data inserted suucessfully</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>';
